...
The basic structure is a mobile application (henceforth known as mobile app) for Android and iOS that the user interacts with, and a server (henceforth known as web app) that the staff can log into in order to view transactions, user details and to update the mobile app.
...
% mobile app features
The components contained within the mobile app include a login page, registration page, about the company page, user details page, a way to top up and a way to order sandwiches.
...
Ronan Connolly \& Vladislav Marisevs are the authors of this project. 
